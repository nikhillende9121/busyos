...
// Copy of app/(dashboard)/sale-exchanges/page.tsx — nothing to trim here,
// same reasoning as the store sale-returns page: no warehouse field, GET
// /sales already comes back scoped to the caller's own store. See
...
export default function StoreSaleExchangesPage() {
